...
namespace ExemploApiCatalogoJogos.InputModel
{
    public class JogoInputModel
    {
        ...
        [Required]
        [StringLength(100, MinimumLength = 3, ErrorMessage = "O tipo do jogo deve conter entre 3 e 100 caracteres")]
        public string Tipo { get; set; }

        [Required]
        [StringLength(100, MinimumLength = 3, ErrorMessage = "O país de origem deve conter entre 3 e 100 caracteres")]
