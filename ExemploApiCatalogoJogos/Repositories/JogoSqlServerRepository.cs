...
namespace ExemploApiCatalogoJogos.Repositories
{
    public class JogoSqlServerRepository : IJogoRepository
    {
        ...
        public async Task<List<Jogo>> Obter(int pagina, int quantidade)
        {
            ...
            while (sqlDataReader.Read())
            {
                jogos.Add(new Jogo
                {
                    ...
                    Tipo = (string)sqlDataReader["Tipo"],
                    PaisOrigem = (string)sqlDataReader["PaisOrigem"]
                });
            }
        ...
        {
            var comando = $"insert Jogos (Id, Nome, Produtora, Preco, Tipo, PaisOrigem) values ('{jogo.Id}', '{jogo.Nome}', '{jogo.Produtora}', {jogo.Preco.ToString().Replace(",", ".")}, '{jogo.Tipo}', '{jogo.PaisOrigem}')";
        ...
        {
            var comando = $"update Jogos set Nome = '{jogo.Nome}', Produtora = '{jogo.Produtora}', Preco = {jogo.Preco.ToString().Replace(",", ".")}, Tipo = '{jogo.Tipo}', PaisOrigem = '{jogo.PaisOrigem}' where Id = '{jogo.Id}'";
